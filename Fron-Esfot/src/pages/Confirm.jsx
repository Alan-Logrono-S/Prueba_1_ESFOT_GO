...
export const Confirm = () => {
    ...
    return (
        ...
        <div className="bg-gradient-to-tr from-blue-950 via-red-900 to-black flex flex-col items-center justify-center h-screen">

            <ToastContainer/>
            
            <div className="object-cover h-80 w-80 border-4 border-solid border-black bg-[url('./assets/dragonc.png')] bg-cover bg-center"></div>
